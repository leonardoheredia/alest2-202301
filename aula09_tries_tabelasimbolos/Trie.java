package aula09_tries_tabelasimbolos;
...
/*
* Implementação didática de uma TRIE simples para criar árvore de prefixos.
* Limitada apenas a palavras com alfabeto de [A..Z], maiusculo
* */
public class Trie {
